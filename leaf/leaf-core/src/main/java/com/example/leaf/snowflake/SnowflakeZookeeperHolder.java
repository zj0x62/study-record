...
import com.example.leaf.snowflake.exception.CheckLastTimeException;
...
public class SnowflakeZookeeperHolder {
    ...
    private static final String PROP_PATH = System.getProperty("java.io.tmpdir") + File.separator + PropertyFactory.getProperties().getProperty("leaf.name") + "/leafconf/{port}/workID.properties";
    ...
    private void scheduleUploadData(final CuratorFramework curator, final String zk_AddressNode) {
        ...
        }, 1L, 3L, TimeUnit.SECONDS);//每3秒上报数据
    }
